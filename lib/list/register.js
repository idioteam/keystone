...
const set_roles = require('./roles/set');
...
function register () {
	...
	if (this.get('seo')) {
		schemaPlugins.seo.apply(this);
	}

	this.set('ui_access', set_roles.call(this, this.get('ui_access')));
	this.set('ui_can_add', set_roles.call(this, this.get('ui_can_add') || this.get('ui_crud')));
	this.set('ui_can_delete', set_roles.call(this, this.get('ui_can_delete') || this.get('ui_crud')));
	this.set('ui_can_edit', set_roles.call(this, this.get('ui_can_edit') || this.get('ui_crud')));
